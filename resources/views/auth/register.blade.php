...
<body>
    <div class="container1">
            ...
            <div class="form-container">
                ...
                <form class="register-form" action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="confirm-password" name="password_confirmation" placeholder="Password" class="form-input" />
        ...
        <div class="image-section">
            <img class="background-image" src="https://media.licdn.com/dms/image/v2/D5612AQFsCm0-etbyaQ/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1698050318906?e=2147483647&v=beta&t=pPvg7fcTpi8wTE5tn2craTnQs_7M0-ekOG6CPutHCiY" alt="Background" />
        </div>
