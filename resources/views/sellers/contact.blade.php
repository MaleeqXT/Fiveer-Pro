        ...
        <div class="card-body">
            <div class="tab-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($buyers as $buyer)
                                    <tr>
                                        <td>
                                            <img src="{{ asset($buyer->buyer_image) }}" width="50" height="50" alt="{{ $buyer->buyer_name }}">
                                        </td>
                                        <td>{{ $buyer->buyer_name }}</td>
                                        <td>{{ $buyer->completed_orders }}</td>
                                        <td>{{ $buyer->amount_spent }}</td>
                                        <td>{{ $buyer->last_order->format('d-m-Y') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="tab-pane fade text-center" id="card3-profile" style="padding: 20%">
                    <h5><i class="fas fa-exclamation-circle icon"></i>You have yet to order any Gigs...</h5>
                </div>
            </div>
        </div>
    </div>
