...
.tab-pane {
        margin-bottom: 0 !important; /* Ensure no margin is applied */
        padding-bottom: 0 !important; /* Remove padding */
    }

    .tab-pane form {
        margin-bottom: 0 !important; /* Remove any margin on forms */
        padding-bottom: 0 !important; /* Remove any padding */
    }

    .button-container {
        text-align: right; /* Align buttons to the right */
        margin-bottom: 0 !important; /* Ensure no extra margin below the button container */
    }

    .faq-item {
        margin-bottom: 10px; /* Consistent spacing between FAQ items */
    }

    .container:last-child {
        margin-bottom: 0 !important; /* Ensure no bottom margin for the container */
    }

    hr {
        margin: 1rem 0; /* Adjust the spacing for horizontal rules */
    }

    .mt-5:last-child,
    .mb-5:last-child {
        margin-bottom: 0 !important; /* Remove margin from the last child */
    }
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <style>
                        ...
                        .tab-pane form {
                            padding-bottom: 0 !important; /* Remove padding inside the form */
                        }
                        ...
                        .form-control, 
                        .form-select {
                            margin-bottom: 10px; /* Maintain consistent spacing between inputs */
                        }
                    
                        .btn-primary {
                            background-color: #007bff;
                            border-color: #007bff;
                            margin-bottom: 0 !important; /* Ensure buttons don't add extra bottom space */
                        }
                        ...
                        .gig-metadata {
                            margin-bottom: 0 !important; /* Ensure no extra margin for metadata section */
                        }
                    
                        .tab-pane .row:last-of-type {
                            margin-bottom: 0 !important; /* Remove margin for the last row */
                        }
                    </style>
